# Robust BOCPD Fast-Alarm Channel for Stress Onset — Pre-Registered Test Protocol (DRAFT)

**Status**: DRAFT — skill-trial exercise, NOT frozen, NOT tagged, no test code
exists. If adopted for real, this file is renamed `protocol_bocpd.md`, frozen,
and tagged `bocpd-test-preregistered` via the sanctioned write path BEFORE any
runnable test code is written. Moving any threshold after that tag invalidates
