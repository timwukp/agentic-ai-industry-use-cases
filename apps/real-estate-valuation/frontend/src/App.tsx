...
import { MessageSquare, Home, TrendingUp, DollarSign, Building2 } from 'lucide-react'
import ChatPanel from './components/ChatPanel'
import PropertyDashboard from './components/PropertyDashboard'
import MarketAnalysis from './components/MarketAnalysis'
import InvestmentAnalysis from './components/InvestmentAnalysis'

type Tab = 'chat' | 'properties' | 'market' | 'investment'
...
export default function App() {
  ...
  const tabs = [
    ...
    { id: 'investment' as Tab, label: 'Investment', icon: DollarSign },
  ]
      ...
      <nav className="w-64 bg-gray-900 border-r border-gray-800 flex flex-col">
        <div className="p-6 border-b border-gray-800">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold text-white">ValuAI</h1>
