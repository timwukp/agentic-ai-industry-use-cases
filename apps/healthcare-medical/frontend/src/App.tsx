...
import { MessageSquare, Users, Heart, BarChart3, Cross } from 'lucide-react'
import ChatPanel from './components/ChatPanel'
import PatientDashboard from './components/PatientDashboard'
import ClinicalSupport from './components/ClinicalSupport'
import HealthAnalytics from './components/HealthAnalytics'

type Tab = 'chat' | 'patients' | 'clinical' | 'analytics'
...
export default function App() {
  ...
  const tabs = [
    ...
    { id: 'clinical' as Tab, label: 'Clinical', icon: Heart },
  ...
  return (
    <div className="flex h-screen bg-gray-950">
      ...
      <nav className="w-64 bg-gray-900 border-r border-gray-800 flex flex-col">
        <div className="p-6 border-b border-gray-800">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold text-white">MedAI</h1>
      ...
      <main className="flex-1 overflow-hidden">
        ...
        {activeTab === 'clinical' && <ClinicalSupport />}
