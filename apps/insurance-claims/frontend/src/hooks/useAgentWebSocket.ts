  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '0',
      role: 'assistant',
      content: 'Hello! I\'m your AI Claims Processing Assistant powered by AWS Bedrock AgentCore. I can help you with:\n\n' +
        '- **Claim Submission & Tracking** - File new claims, check status, manage documents\n' +
        '- **Damage Assessment** - AI-powered damage evaluation and repair estimates\n' +
        '- **Fraud Detection & Investigation** - Analyze claims for suspicious patterns\n' +
        '- **Settlement Calculation** - Estimate payouts based on policy and damage\n' +
        '- **Policy Verification & Coverage Checks** - Verify coverage, limits, and exclusions\n\n' +
