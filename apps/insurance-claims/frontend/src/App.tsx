...
import { FileText, BarChart3, Shield, MessageSquare, ShieldCheck } from 'lucide-react'
import ChatPanel from './components/ChatPanel'
import ClaimsDashboard from './components/ClaimsDashboard'
import FraudAlerts from './components/FraudAlerts'
import SettlementAnalytics from './components/SettlementAnalytics'

type Tab = 'chat' | 'claims' | 'fraud' | 'analytics'
...
export default function App() {
  ...
  const tabs = [
    ...
    { id: 'fraud' as Tab, label: 'Fraud Detection', icon: Shield },
      ...
      <nav className="w-64 bg-gray-900 border-r border-gray-800 flex flex-col">
        <div className="p-6 border-b border-gray-800">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold text-white">ClaimsAI</h1>
