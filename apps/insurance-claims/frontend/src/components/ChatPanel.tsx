...
export default function ChatPanel() {
  ...
  const quickActions = [
    ...
    'Run fraud analysis on CLM-2026-ABC123',
    'Check policy POL-2024-001234',
    'Calculate settlement for recent claim',
  ]
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-6 py-4 border-b border-gray-800 bg-gray-900/50">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-lg font-semibold text-white">AI Claims Assistant</h2>
      ...
      <form onSubmit={handleSubmit} className="p-4 border-t border-gray-800 bg-gray-900/50">
        <div className="flex items-center gap-3">
          <input
            ...
            placeholder="Ask about claims, policies, fraud detection, or settlements..."
            className="flex-1 px-4 py-3 bg-gray-800 border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500"
            disabled={isLoading}
          />
          <button
            type="submit"
            disabled={!input.trim() || isLoading}
            className="p-3 bg-indigo-600 rounded-xl text-white hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
