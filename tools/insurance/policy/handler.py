...
COVERAGE_MAP = {
    "auto": {"liability": 300000, "collision": 50000, "comprehensive": 50000,
             "medical": 10000, "uninsured": 100000},
    "homeowners": {"dwelling": 500000, "personal_property": 250000, "liability": 300000,
                   "medical": 5000, "additional_living": 100000},
    "health": {"annual_max": 1000000, "deductible": 2500, "out_of_pocket_max": 8000,
               "copay": 30, "coinsurance_pct": 20},
    "life": {"death_benefit": 500000, "accidental_death": 1000000, "cash_value": 50000},
    "commercial": {"general_liability": 1000000, "property": 500000,
                   "business_interruption": 250000, "workers_comp": 500000},
...
def verify_policy(policy_number: str) -> dict:
    ...
    return tool_ok({
        ...
        "premium": {
            ...
            "next_due": (today + timedelta(days=r.randint(1, 30))).strftime("%Y-%m-%d"),
            "paid_to_date": True,
        },
        "coverage": COVERAGE_MAP[policy_type],
        "deductible": round(r.uniform(250, 5000), 2),
        "endorsements": r.sample(
            ["Roadside assistance", "Rental car coverage", "Flood insurance",
             "Jewelry rider", "Home office coverage"], k=r.randint(0, 3)),
    }, simulated=True)
...
def check_coverage(policy_number: str, claim_type: str, claimed_amount: float) -> dict:
    ...
    return tool_ok({
        ...
        "notes": ("Claim falls within policy coverage and limits" if is_covered
